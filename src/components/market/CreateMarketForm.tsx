...
const outcomeTypeOptions = [
  { value: OutcomeType.BINARY, label: 'Binary (Yes/No)', description: 'Simple yes or no question' },
  { value: OutcomeType.CATEGORICAL, label: 'Categorical', description: 'Multiple choice options' },
  { value: OutcomeType.SCALAR, label: 'Scalar (Number)', description: 'Numerical outcome prediction' }
];
    ...
    <div className="max-w-7xl mx-auto p-6 bg-gray-900 text-white">
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Set up your prediction market with clear questions, resolution criteria, and trading parameters.
        </p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  value={form.category}
                  onChange={(e) => handleInputChange('category', e.target.value as MarketCategory)}
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleInputChange('outcomeType', e.target.value as OutcomeType)}
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                >
                ...
                <p className="text-sm text-gray-400 mt-1">
                  {outcomeTypeOptions.find(opt => opt.value === form.outcomeType)?.description}
                </p>
              </div>
            </div>
          </div>
